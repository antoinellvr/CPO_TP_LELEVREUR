...
public class GrilleDeJeu {
    ...
    public String toString() {
      ...
      // Méthode pour activer de manière aléatoire une ligne, une colonne ou une diagonale de cellules
  ...
  // Méthode pour générer un plateau de cellules lumineuses de manière aléatoire
